...
export default function EditPermutationUI() {
  ...
  function applyEdit() {
    ...
    if (initialPrefixLen > 0 &&
      ...
      // case (transposed space) // This was the original problematic line, now correctly a comment or a fixed statement below
    ...
    if (isSentenceAddition) {
      ...
      drafts.forEach((dArr, draftIndex) => {
        ...
        if (anchorIdIndexInDArr === -2) {
          ...
          let matchBoundary; // Renamed to avoid conflict with outer 'match'
